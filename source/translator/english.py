...
class English(Chinese):
    ...
    download_link_error: str = "Failed to extract the download address for the Xiaohongshu work files!"
    extract_link_failure: str = "Failed to extract the links for Xiaohongshu works!"
    invalid_link: str = "No Xiaohongshu work links provided!"
    download_failure: str = "Failed to download the Xiaohongshu work files!"
    check_update_notification: str = "Checking for new version, please wait..."
    development_version_update: str = "The current version is a development version, and can be updated to the official version!"
    ...
    input_box_title: str = "Please enter the link to the Xiaohongshu image/text or video work:"
    input_prompt: str = "Separate multiple links with spaces"
    download_button: str = "Download images/videos without watermarks"
    ...
    def start_processing(url: str) -> str:
        return f"Start processing the work: {url}"
